    ...
    <section className="bg-gray-600 text-white">
      <div className='flex flex-row justify-center items-center'>
        <div className="mx-auto py-12 px-12 sm:px-6 lg:px-8 flex flex-col items-center justify-center relative flex-grow w-5/12" data-aos="fade-left">
          <h1 className="bg-gray-600 pl-4 pb-4 top-0 translate-y-12 translate-x-24 text-4xl absolute font-normal flex items-center justify-center z-20 rounded-bl-xl">
            Kaisar <br /> fauzan
          </h1>
          <div className="flex flex- items-center justify-center h-96 w-80 relative ">
            ...
            <h1 className=" p-4 bottom-0  bg-gray-600 -translate-y-9 -translate-x-24 text-xl absolute font-normal flex items-center justify-center z-20 rounded-tr-xl">
              Front-end <br/> Developer
            </h1>
        </div>
        <div className='mx-auto py-12 px-20 flex-grow w-7/12 'data-aos="fade-right">
          <h1 className='text-3xl font-bold text-justify my-8 '>
